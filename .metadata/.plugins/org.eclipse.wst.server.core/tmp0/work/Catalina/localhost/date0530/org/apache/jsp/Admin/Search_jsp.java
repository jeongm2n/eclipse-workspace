 ...
 * Generated at: 2023-06-09 06:15:30 UTC
...
if(!value.equals("")){
	...
	sql = "SELECT * FROM usrregist WHERE usrregist.dept_no=dept.dept_no AND "+column+" BETWEEN '"+start+"' AND '"+end+"'";
      ...
      out.write("	<script>\n");
      out.write("		var options = ['ID','비밀번호','이름','부서','출생년도','출생월','전화번호','이메일','우편번호','지번주소','도로명 주소','상세주소'];\n");
      out.write("		var value = ['member_id','member_pwd','member_name','dept_no','birth_y','birth_month','tel','email','addr_post','addr_lot','addr_road','addr_rest'];\n");
